    ...
    <div className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-50" ref={controlsRef}>
      <div className="relative">
        <div className="flex items-center gap-2">
          ...
          <motion.button
            onClick={toggleMusic}
            className="w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-[#D4AF37] transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50"
            style={{
              background: 'linear-gradient(135deg, rgba(23, 22, 16, 0.9) 0%, rgba(51, 51, 51, 0.8) 100%)',
              backdropFilter: 'blur(10px)',
              boxShadow: '0 4px 16px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(212, 175, 55, 0.1)',
