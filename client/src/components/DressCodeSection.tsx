  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          <div className="bg-white border-0 rounded-xl p-8 hover-elegant transition-all duration-500 relative" style={{ boxShadow: '0 10px 30px -5px rgba(216, 181, 181, 0.4)' }}>
