...
import Gemini_Generated_Image_jws5syjws5syjws5_removebg_preview from "@assets/Gemini_Generated_Image_jws5syjws5syjws5-removebg-preview.png";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <img src={Gemini_Generated_Image_jws5syjws5syjws5_removebg_preview} alt="I&R" className="h-12 w-12 object-contain" />
          </div>
